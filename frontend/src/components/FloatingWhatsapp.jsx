    ...
    <div className="fixed bottom-6 left-6 z-10 group">
      ...
      >
        <a
          ...
          className="bg-black text-white px-5 py-2 rounded shadow text-sm mb-2"
        >
          📦 Ventas al por mayor
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-black text-white px-8 py-2 rounded shadow text-sm mb-2"
        >
          🛒 Ventas al detalle
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-black text-white px-4 py-2 rounded shadow text-sm mb-2"
        >
